...
public class FreeVideoPlayerServlet extends HttpServlet
{

    private final static Logger LOGGER = Logger.getLogger(FreeVideoPlayerServlet.class.getName());
    ...
    {
        Long prevId = Long.parseLong(req.getParameter("prevId"));
        Session sess = (Session) Component.getInstance("hibernateSession");
        //
        Preview item = (Preview) sess.get(Preview.class, prevId);
